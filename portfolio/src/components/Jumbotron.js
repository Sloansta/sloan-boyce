...
const Jumbotron = () => {
    return (
        <div className="top-0 left-0 min-h-screen flex flex-col items-center justify-center">
            <img 
            className="absolute w-full h-full object-cover bg-fixed"
            src={Image} 
            alt="Osaka" 
            />
            <div className="p-12 font-bold z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.9)] text-center items-center flex-grow-0 transition-all duration-1000">
